 ...
 * Description:
 */
public class VerticalDragList extends FrameLayout {
    ...
    public VerticalDragList(Context context) {
        this(context, null);
    }

    public VerticalDragList(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VerticalDragList(Context context, AttributeSet attrs, int defStyleAttr) {
